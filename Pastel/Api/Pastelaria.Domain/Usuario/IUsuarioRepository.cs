...
namespace Pastelaria.Domain.Usuario
{
    public interface IUsuarioRepository
    {
        ...
        // Método para obter gestores (ou administradores)
        // Retorna uma lista de objetos UsuariosDto representando os gestores
        IEnumerable<UsuariosDto> GetGestores();
        ...
        // Aceita um parâmetro 'Id' representando o ID do usuário a ser excluído
        void Delete(int Id);
