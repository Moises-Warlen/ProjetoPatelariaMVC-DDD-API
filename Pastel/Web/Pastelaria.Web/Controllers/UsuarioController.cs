...
namespace Pastelaria.Web.Controllers
{
   // Apenas usuários autenticados podem acessar este controlador
    public class UsuarioController : BaseController
    {
        ...
        {
            // Buscar gestores e perfis para preenchimento dos campos de seleção
            var responseGestores = _usuarioApplication.GetGestores();
            if (!responseGestores.Ok)
                return Error("Falha ao buscar gestores");
            ...
            if (!id.HasValue)
                return View("_Form", new EditarUsuarioModel
                {
                    ...
                    Gestores = responseGestores.Content,
