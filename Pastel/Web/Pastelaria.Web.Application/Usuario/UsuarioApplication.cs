...
public class UsuarioApplication : BaseApplication
{
    ...
    // Método para obter uma lista de gestores, enviando uma requisição GET para o endpoint "gestores"
    public Response<IEnumerable<UsuarioModel>> GetGestores()
        => Request.Get("gestores").AsResponse<IEnumerable<UsuarioModel>>();
